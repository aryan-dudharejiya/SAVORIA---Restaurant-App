  ...
  return (
    <>
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        ...
        <div 
          className={`absolute inset-0 bg-cover bg-center transition-opacity duration-1500 transform scale-105 ${isImagesLoaded ? 'opacity-100' : 'opacity-0'}`}
          style={{ 
        ...
        <div className="container mx-auto px-6 z-10 text-left lg:text-center relative">
          ...
          <div className="inline-block mb-4 animate-pulse">
            ...
            >
              <span className="animate-pulse mr-1">✦</span> FINE DINING EXPERIENCE <span className="animate-pulse ml-1">✦</span>
            </Badge>
          </div>
          ...
          <p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-8 opacity-0 animate-[fadeIn_1s_ease-in-out_0.4s_forwards] leading-relaxed font-light">
            Experience the art of fine dining with our exquisite dishes prepared by 
            world-class chefs using the freshest local ingredients
          </p>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce hidden md:flex flex-col items-center">
          <p className="text-white/70 text-sm mb-2 tracking-wider font-light">SCROLL DOWN</p>
          <div className="w-8 h-12 rounded-full border-2 border-white/60 flex items-start justify-center">
            <div className="w-1.5 h-3 bg-white rounded-full mt-2 animate-[scrollDown_1.5s_infinite]"></div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row bg-white rounded-xl shadow-xl overflow-hidden transform hover:shadow-2xl transition-all duration-500">
              <div className="md:w-1/2 p-8 md:p-10 bg-gradient-to-br from-primary to-primary/80 text-white relative">
                ...
                <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4 drop-shadow-sm">Opening Hours</h2>
                <p className="mb-8 text-white/90 leading-relaxed">We are open 7 days a week to serve you the finest cuisine in an elegant atmosphere.</p>
                ...
                <ul className="space-y-5">
                  <li className="flex justify-between items-center border-b border-white/20 pb-3">
                    ...
                    <span className="font-light text-white/90">11:00 AM - 10:00 PM</span>
                  </li>
                  <li className="flex justify-between items-center border-b border-white/20 pb-3">
                    <div className="flex items-center">
                      <Clock className="h-5 w-5 mr-3 opacity-80" />
                    ...
                    <span className="font-light text-white/90">11:00 AM - 11:30 PM</span>
                  </li>
                  <li className="flex justify-between items-center">
                    ...
                    <span className="font-light text-white/90">10:00 AM - 10:00 PM</span>
                  </li>
                </ul>
                
                <div className="mt-10">
                  <Link href="/reservation">
                    <Button variant="outline" className="border-white hover:bg-white hover:text-primary rounded-full px-5 transition-all">
                      Reserve a Table
                    </Button>
                  </Link>
                </div>
      ...
      <section className="py-20 bg-gray-50 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="font-accent text-primary text-3xl mt-2">Our Specialties</p>
            <h2 className="font-heading text-4xl md:text-5xl font-bold mt-3 mb-6">Chef's Recommendations</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {isLoading ? (
              ...
              specialItems?.map((item) => (
                <Card key={item.id} className="overflow-hidden shadow-xl menu-card rounded-xl border-0">
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-bold text-primary text-lg">${parseFloat(item.price.toString()).toFixed(2)}</span>
                    </div>
          ...
          <div className="text-center mt-12">
            <Link href="/menu">
              <Button variant="outline" className="rounded-full px-6 border-gray-300 hover:border-primary/70 hover:bg-primary/5">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <div className="text-center mb-16">
            ...
            <p className="font-accent text-primary text-3xl mt-2">Explore Our Menu</p>
            <h2 className="font-heading text-4xl md:text-5xl font-bold mt-3 mb-6">Popular Dishes</h2>
            <p className="max-w-2xl mx-auto text-gray-600">
              Browse through our most ordered dishes and customer favorites, each crafted with passion
            </p>
          </div>
              ...
              <Carousel className="w-full" opts={{ loop: true }}>
                <CarouselContent>
                  {allMenuItems?.map((item) => (
                    <CarouselItem key={item.id} className="md:basis-1/2 lg:basis-1/3 pl-4 pb-10">
                      <div className="p-1">
                        <Card className="overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border-0 rounded-xl h-full">
                          ...
                          <CardContent className="p-4">
                            <div className="flex justify-between items-center mb-2">
                              <h3 className="font-heading text-lg font-bold line-clamp-1">{item.name}</h3>
          ...
          <div className="text-center mt-12">
            <Link href="/menu">
              <Button variant="outline" className="rounded-full px-8 border-gray-300 hover:border-primary/70 hover:bg-primary/5 h-12">
      ...
      <section className="py-20 bg-gray-50 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="font-accent text-primary text-3xl mt-2">Restaurant Features</p>
            <h2 className="font-heading text-4xl md:text-5xl font-bold mt-3 mb-6">What We Offer</h2>
            <p className="max-w-2xl mx-auto text-gray-600">
              Experience the perfect dining ambiance with our premium amenities and services designed for your comfort
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="group">
              <Card className="text-center p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm overflow-hidden">
                ...
                <h3 className="font-heading text-xl font-bold mb-3">Prime Location</h3>
                <p className="text-gray-600">Located in the heart of the city with convenient parking facilities and easy access to public transport</p>
              </Card>
            </div>
            ...
            <div className="group">
              <Card className="text-center p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm overflow-hidden">
                ...
                <h3 className="font-heading text-xl font-bold mb-3">Free Wi-Fi</h3>
                <p className="text-gray-600">Stay connected with our complimentary high-speed wireless internet throughout the restaurant</p>
              </Card>
            </div>
            ...
            <div className="group">
              <Card className="text-center p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm overflow-hidden">
                ...
                <h3 className="font-heading text-xl font-bold mb-3">Live Music</h3>
                <p className="text-gray-600">Enjoy live performances by talented musicians every Friday and Saturday evening</p>
              </Card>
            </div>
            ...
            <div className="group">
              <Card className="text-center p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm overflow-hidden">
                ...
                <h3 className="font-heading text-xl font-bold mb-3">Outdoor Seating</h3>
                <p className="text-gray-600">Dine in our beautiful garden terrace with spectacular views of the city skyline</p>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="font-accent text-primary text-3xl mt-2">Testimonials</p>
            <h2 className="font-heading text-4xl md:text-5xl font-bold mt-3 mb-6">What Our Customers Say</h2>
            <p className="max-w-2xl mx-auto text-gray-600">
              Read genuine reviews from our valued customers who have experienced our hospitality and cuisine
            </p>
          </div>
          
          <div className="relative">
            {/* Quote decorations */}
            <div className="hidden md:block absolute -top-10 left-10 text-9xl text-primary/10 font-serif">"</div>
            <div className="hidden md:block absolute -bottom-10 right-10 text-9xl text-primary/10 font-serif rotate-180">"</div>
              ...
              <Carousel className="w-full max-w-5xl mx-auto" opts={{ loop: true }}>
                <CarouselContent>
                  {reviews?.map((review: Review) => (
                    <CarouselItem key={review.id} className="md:basis-1/2 lg:basis-1/3 pl-4 pb-10">
                      <Card className="p-8 h-full flex flex-col shadow-lg hover:shadow-xl transition-all duration-300 border-0 rounded-xl">
                        <div className="flex items-center mb-6">
                          ...
                          <div className="ml-4">
                            <h4 className="font-heading text-lg font-bold">{review.name}</h4>
                        ...
                        <div className="relative">
                          <div className="absolute -left-2 -top-2 text-3xl text-primary/20 font-serif">"</div>
                          <p className="text-gray-600 flex-grow italic pt-2 px-3 leading-relaxed">{review.review}</p>
                          <div className="absolute -right-2 bottom-0 text-3xl text-primary/20 font-serif rotate-180">"</div>
                        </div>
          ...
          <div className="text-center mt-12">
            <p className="mb-4 text-gray-600">Rated 4.8 out of 5 based on 240+ reviews</p>
            <Link href="/reviews">
              <Button variant="outline" className="rounded-full px-8 border-gray-300 hover:border-primary/70 hover:bg-primary/5 h-12">
