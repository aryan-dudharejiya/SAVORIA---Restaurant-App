          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <h1 className="text-white text-4xl md:text-6xl lg:text-7xl font-bold mb-4 leading-tight">
                Extraordinary <span className="text-primary">Flavors</span>,{" "}
                <br />
              ...
              <p className="text-white/80 text-lg mb-8 max-w-xl">
                ...
                Our culinary artisans craft each dish with passion using only
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Founded in 2008, Savoria has been a beacon of culinary
                excellence, combining traditional techniques with innovative
                flavors to create an extraordinary dining experience.
              </p>
              <p className="text-gray-700 mb-8 leading-relaxed">
                Our philosophy is simple - use the finest seasonal ingredients,
                prepare them with precision and care, and serve them in an
                atmosphere of warmth and sophistication. Every dish tells a
                story of passion and craftsmanship.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Experience our chef's carefully crafted signature dishes,
              featuring the finest ingredients and innovative culinary
              techniques.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
            ...
            <p className="text-gray-600 max-w-md mt-4 md:mt-0">
              Discover our most ordered dishes, loved by customers for their
            ...
            {isReviewsLoading
              ? Array(3)
                  ...
                  .map((_, index) => (
                    <div
                      key={index}
                      className="bg-gray-100 p-6 rounded-lg animate-pulse h-64"
                    ></div>
                  ))
              : reviews?.slice(0, 3).map((review) => (
                  ...
                  >
                    ...
                    <p className="text-gray-700 line-clamp-4 mb-3">
                      {review.review}
                    </p>
                  </div>
                ))}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-8">
                We are conveniently located in the heart of the city, offering
                easy access and a welcoming atmosphere for your dining pleasure.
              </p>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-white/80 max-w-2xl mx-auto mb-10 text-lg">
              Join us at Savoria for a culinary journey that will delight your
