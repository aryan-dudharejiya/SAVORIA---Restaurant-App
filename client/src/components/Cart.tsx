...
const Cart = ({ onClose }: CartProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end overflow-hidden">
      ...
      >
        {/* Header */}
        <div className="relative px-6 py-8 bg-gradient-to-r from-primary to-primary/80 text-white">
          <Button
            variant="ghost"
            size="icon"
            ...
            <div className="flex-grow overflow-y-auto p-6 pb-0 border-b border-gray-100">
              ...
              <div className="mb-6">
                ...
                >
                  <Gift
                    size={16}
                    className={`mr-2 ${promoApplied ? "text-green-500" : "text-primary"}`}
                  />
                  ...
                  {promoApplied && (
                    ...
                    >
                      <div className="flex items-center">
                        <Badge className="bg-green-100 text-green-800 mr-2 font-normal shadow-sm">
                          20% OFF
                        </Badge>
