  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex justify-end overflow-hidden">
        ...
        {/* Cart Panel */}
        <motion.div 
          className="relative z-10 w-full sm:w-[420px] h-full bg-white shadow-2xl flex flex-col"
        ...
        >
          {/* Header */}
          <div className="relative px-6 pt-8 pb-7 bg-gradient-to-r from-primary to-primary/80 text-white">
            <button
              onClick={onClose}
